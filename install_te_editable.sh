...
TRANFORMER_ENGINE_PATH=${current_dir}/thirdparty/transformerengine
uv pip install --no-build-isolation --editable ${TRANFORMER_ENGINE_PATH} -v  2>&1 | tee install.log